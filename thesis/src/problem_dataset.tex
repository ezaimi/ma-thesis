...
% TODO-FULL-RUN: update after full 187-row evaluation
\fullrunupdate{It is important not to read the 187-row \texttt{evaluation}
split as already evaluated. Splitting the data this way only
\emph{reserves} those rows for a later, controlled repair run; at the
implementation stage this thesis reports, that run has not yet happened
...
reserved for a full evaluation.

% TODO-FULL-RUN: update after full 187-row evaluation
\fullrunupdate{That full evaluation has not yet been run.}
